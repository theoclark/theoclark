...
### 3. App to convert landscape photos into Monet style paintings using CycleGAN.
...
### 4. Model to generate handwritten digits using WGAN-GP.
[**Repo**](https://github.com/theoclark/MNIST-PyTorch-WGAN-GP) | [**Blog**](https://theoclark.co.uk/posts/wasserstein-gan.html)
